<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="UTI_GrupoLaranja.Index" %>
...
<!-- FIM HEADER  -->
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center orange-text">Computador Central</h1>
      <div class="row center">
        <h5 class="header col s12 light">É o computador Central que controla tudo</h5>
      </div>
      <div class="row center">
